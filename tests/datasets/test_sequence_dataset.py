...
class TestSequenceDatasetItemShapesNoPadding:
    ...
    def test_static_shape(self, event_pool):
        ds = SequenceDataset(
            event_pool, features=["value"], static_features=["age"], fill_value=0.0
        )
        item = ds[0]
...
class TestSequenceDatasetItemShapesWithPadding:
    def test_temporal_shape_padded(self, event_pool):
        ds = SequenceDataset(
            event_pool, features=["value"], static_features=[], max_len=20
        )
        item = ds[0]
    ...
    def test_temporal_shape_padded_state(self, state_pool_ts):
        ds = SequenceDataset(
            state_pool_ts, features=["value"], static_features=[], max_len=20
        )
        item = ds[0]
    ...
    def test_features_shape_padded(self, event_pool):
        ds = SequenceDataset(
            event_pool, features=["value", "flag_valid"], static_features=[], max_len=20
        )
        item = ds[0]
    ...
    def test_truncation_to_max_len(self, event_pool):
        ...
        ds = SequenceDataset(
            event_pool, features=["value"], static_features=[], max_len=3
        )
        item = ds[0]
